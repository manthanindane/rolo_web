...
import { MapPin, Clock, Star, Car, ArrowLeft, Route, Calendar } from 'lucide-react';
...
export default function RideHistory() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0B] pb-20 relative overflow-hidden font-['Plus_Jakarta_Sans']">
      ...
      <div className="relative z-10 p-6">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white mb-1 animate-fade-in">Ride History</h1>
            <p className="text-white/60 text-sm">Track all your premium journeys</p>
          </div>
        </div>
