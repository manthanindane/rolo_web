...
import { MapPin, Clock, Star, Car, ArrowLeft, Calendar, Filter, Search } from 'lucide-react';
import { Card, CardContent } from '@/components/ui/card';
import { LuxuryButton } from '@/components/ui/luxury-button';
import { BottomNav } from '@/components/layout/BottomNav';
import { useSupabaseData, type Ride } from '@/hooks/useSupabaseData';
...
export default function RideHistory() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0A0A0B] flex items-center justify-center relative overflow-hidden font-['Plus_Jakarta_Sans'] lg:ml-64">
        {/* Background Effects */}
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-br from-[#1A1F36]/10 via-transparent to-[#00D1C1]/5"></div>
          <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-gradient-radial from-[#00D1C1]/8 via-[#1A1F36]/4 to-transparent rounded-full blur-3xl"></div>
          <div className="absolute bottom-1/3 left-1/4 w-80 h-80 bg-gradient-radial from-[#1A1F36]/6 via-[#00D1C1]/3 to-transparent rounded-full blur-3xl"></div>
        </div>
        
        <div className="relative z-10 text-center">
          <div className="relative mb-6">
            <div className="w-12 h-12 border-2 border-[#00D1C1]/30 border-t-[#00D1C1] rounded-full animate-spin mx-auto"></div>
            <div className="absolute inset-0 w-12 h-12 border border-white/10 rounded-full mx-auto"></div>
          </div>
    ...
    <div className="min-h-screen bg-[#0A0A0B] relative overflow-hidden font-['Plus_Jakarta_Sans']">
      ...
      <div className="lg:hidden">
        <div className="relative z-10">
          ...
          <div className="px-6 pt-12 pb-6">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex-1">
                <h1 className="text-2xl font-bold text-white mb-1">Ride History</h1>
            ...
            <div className="flex gap-3 mb-6">
              <div className="flex-1 relative">
                ...
                <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl px-4 py-3 flex items-center gap-3">
              ...
              <div className="relative group">
                ...
                <LuxuryButton
                  variant="ghost"
                  size="icon"
                  className="relative bg-white/5 border border-white/10 text-white/70 hover:text-white hover:bg-white/10 transition-all duration-300 rounded-xl w-12 h-12 flex items-center justify-center"
                >
          ...
          {/* Mobile Content - with proper bottom padding for nav */}
              ...
              <div className="space-y-4">
                {rides.map((ride, index) => (
                  <div key={ride.id} className="relative group" style={{ animationDelay: `${index * 0.1}s` }}>
                    ...
                    <Card className="relative bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl hover:bg-black/50 transition-all duration-300">
                        ...
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-white/40 text-xs font-medium">{ride.vehicle?.name || 'Unknown Vehicle'}</p>
                            </div>
                          </div>
                        ...
                        <div className="space-y-3 mb-4">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 space-y-3 min-w-0">
                              <div>
                                <p className="text-sm font-medium text-white mb-1">From</p>
                                <p className="text-sm text-white/70 break-words">{ride.pickup_location}</p>
                              </div>
                              <div>
                                <p className="text-sm font-medium text-white mb-1">To</p>
                                <p className="text-sm text-white/70 break-words">{ride.dropoff_location}</p>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          {ride.status === 'completed' && (
                            <div className="relative group/btn">
                              ...
                              <LuxuryButton 
                                variant="ghost" 
                                size="sm"
                                className="relative bg-white/5 border border-white/10 text-white/70 hover:text-white hover:bg-white/10 transition-all duration-300 text-xs font-medium px-3 py-2 rounded-lg"
                              >
                                Book Again
                              </LuxuryButton>
                            </div>
                ...
                <Card className="relative bg-black/40 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl">
                  <CardContent className="p-8 text-center">
                    <div className="relative mb-6">
                      ...
                      <div className="relative w-16 h-16 mx-auto bg-white/5 backdrop-blur-sm border border-white/10 rounded-full flex items-center justify-center">
                    ...
                    <div className="relative group/cta">
                      ...
                      <LuxuryButton 
                        ...
                        className="relative px-6 py-3 bg-gradient-to-r from-[#1A1F36] to-[#00D1C1] text-white font-semibold rounded-full border-0 hover:shadow-2xl hover:shadow-[#00D1C1]/20 transition-all duration-500 group-hover/cta:scale-[1.02] text-sm"
                      >
          ...
          <div className="max-w-7xl mx-auto px-8 py-8">
            ...
            <div className="flex items-center justify-between mb-12">
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h1 className="text-4xl font-bold text-white mb-2">Ride History</h1>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-6">
                {rides.map((ride, index) => (
                  <div key={ride.id} className="relative group" style={{ animationDelay: `${index * 0.05}s` }}>
                    ...
                    <Card className="relative bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl hover:bg-black/50 transition-all duration-300 h-full">
                        ...
                        <div className="flex items-start justify-between mb-6">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-white/40 text-xs font-medium mt-0.5">{ride.vehicle?.name || 'Unknown Vehicle'}</p>
                            </div>
                          </div>
